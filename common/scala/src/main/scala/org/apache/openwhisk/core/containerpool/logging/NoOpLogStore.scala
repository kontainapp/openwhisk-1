...
object NoOpLogStoreProvider extends LogStoreProvider {
  override def instance(actorSystem: ActorSystem): LogStore = new NoOpLogStore()
}

class NoOpLogStore extends LogStore {
  ...
  override def collectLogs(transid: TransactionId,
    ...
    Future.successful(ActivationLogs(Vector("log not implemented")))
  }
